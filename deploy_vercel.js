...
if (!fs.existsSync(envFilePath)) {
  ...
  console.error('Please make sure you run this script from the admin-web directory containing .env.local.');
  process.exit(1);
}
...
// 3. Link project to Vercel (interactive if not already linked)
...
// 4. Parse .env.local variables
console.log('📄 Parsing environment variables from .env.local...');
...
console.log('\n✨ Deployment complete! Your admin dashboard is now hosted online.');
