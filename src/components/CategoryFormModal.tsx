...
export function CategoryFormModal({ isOpen, onClose, onSuccess }: CategoryFormModalProps) {
    ...
    const onSubmit = async (data: CategoryFormValues) => {
        ...
        try {
            ...
            setError(err.message || "An error occurred while saving the category. Name might already exist.");
        } finally {
                ...
                <form onSubmit={handleSubmit(onSubmit as any)} className="p-6">
                    ...
                    <div className="space-y-5">
                        <div>
                            ...
                            <input
                                {...register("name")}
                                type="text"
                                placeholder="e.g. Appetizers, Specials"
                                className="w-full px-4 py-2.5 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all outline-none text-gray-900"
                                autoFocus
                            />
                        ...
                        <div>
                            ...
                            <input
                                ...
                                placeholder="0"
                            />
                            <p className="mt-1.5 text-xs text-gray-500">Lower numbers appear first in the POS.</p>
                    ...
                    <div className="mt-8 flex justify-end gap-3">
                        ...
                        <button
                            ...
                            className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-lg text-sm font-medium shadow-sm transition-colors disabled:opacity-50"
                        >
                            {isSubmitting ? (
